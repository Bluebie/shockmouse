...
var CGPointMake, ObjC, create_mouse_event, dict_proxy, mouse_button_name, mouse_button_names, mouse_buttons, pool, post, update_defaults;
...
update_defaults = function(notification) {
  return exports.defaults = dict_proxy(ObjC.NSUserDefaults('standardUserDefaults')('dictionaryRepresentation'));
};
