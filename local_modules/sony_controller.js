...
var Color, DS4Gamepad, DS4TouchEvent, events, hid, isBluetoothHID, isDS4HID, isUSBHID, tickEmit,
...
DS4Gamepad = (function(_super) {
  ...
  DS4Gamepad.prototype.set = function(changes) {
    ...
    if (this.wireless) {
      return this.hid.sendFeatureReport([0x11, 128, 0, 0xff, 0, 0].concat(packet_data));
    } else {
